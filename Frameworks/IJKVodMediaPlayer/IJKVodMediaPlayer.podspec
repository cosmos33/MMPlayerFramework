Pod::Spec.new do |s|
  s.name         = "IJKVodMediaPlayer"
  s.version      = "1.0.0"
  s.summary      = "IJKVodMediaPlayer"
  s.description  = "封装点播IJKPlayer，包含缓存、预加载"
  s.homepage     = "https://git.wemomo.com/zou.guowei/videocache.git"
  s.license      = "Apache 2.0"
  s.author       = { "zou.guowei" => "zou.guowei@immomo.com" }
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://git.wemomo.com/zou.guowei/videocache.git", :tag => s.name+'/'+s.version.to_s }
